...
8.  **Middleware de Respuesta (`App::applyMiddleware`)**: La `App` intercepta el objeto de respuesta devuelto por el controlador. Esto permite aplicar una capa de middleware final para modificar o enriquecer la respuesta antes de su envío. El caso de uso principal en el framework es la inyección del panel de depuración interactivo en los objetos `ViewResponse`, desacoplando completamente la lógica de depuración de los controladores.
